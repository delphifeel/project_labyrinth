...
#define CORE_OBJECT_DEFINE_AS_STRUCT(TYPE_NAME, TYPE_STRUCT_INTERFACE) 			\
struct TYPE_NAME					 											\
{																				\
...
#define CORE_OBJECT_CREATE(OBJECT_PTR, TYPE_NAME) 	( CORE_AssertPointer(OBJECT_PTR), *(OBJECT_PTR) = CORE_MemAlloc(sizeof(struct TYPE_NAME##_STRUCT)) )
