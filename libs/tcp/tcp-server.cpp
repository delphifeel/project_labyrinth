...
{
    *instance_ptr = (TCPServer *) uv_handle_get_data(handle);
}
                     ...
                     const uint8 data[], uint32 data_size)
{
    ...
    WriteRecord *write_record   = (WriteRecord *) malloc(sizeof(WriteRecord));
...
{
    TCPServer *instance = (TCPServer *) malloc(sizeof(TCPServer));
