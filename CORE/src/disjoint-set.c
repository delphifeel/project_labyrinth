...
static void INTERNAL_FindSubset(DisjointSet instance, int32 value, int32 *subset)
{
	int32 parent;
	...
	{
		INTERNAL_FindSubset(instance, parent, subset);
	} 
	else 
	{
		*subset = value;
...
CORE_Bool DisjointSet_Union(DisjointSet instance, int32 value1, int32 value2)
{
	...
	INTERNAL_FindSubset(instance, value1, &value1_subset);
	INTERNAL_FindSubset(instance, value2, &value2_subset);
